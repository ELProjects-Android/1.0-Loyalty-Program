 ...
 */public class Favorate_Fragment extends Fragment {
    private RecyclerView mRecyclerView;
    Bitmap bm = BitmapFactory.decodeResource(Resources.getSystem(), R.drawable.ccd);
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v =inflater.inflate(R.layout.frangment_favorate,container,false);
        mRecyclerView = (RecyclerView) v.findViewById(R.id.favList);
